...
//  thu
//
//  Created by TRI TRAN on 4/27/17.
...
class feedVC: UITableViewController, CLLocationManagerDelegate {
    ...
    override func viewDidLoad() {
        ...
        label1.font = UIFont(name: "Pacifico", size:23)
        label1.text = "Nearby Photos"
        
        
        //get the user location permission
      ...
      //  tableView.rowHeight = UITableViewAutomaticDimension
        ...
        //receive notificatio from uploadVC
    ...
    func loadPosts() {
        ...
        /*implementation of Find posts related to people who are nearby
         
         let locationQuery = PFQuery(className: "posts")
         query.whereKey("longitude", containedIn:self.locationArray)
         
         query.whereKey("latitude", containedIn:self.locationArray)
                ...
                query.findObjectsInBackgroundWithBlock({ (objects:[PFObject]?, error:NSError?) -> Void in
                    if error == nil {
                        ...
                        for object in objects! {
                            ...
                            self.picArray.append(object.objectForKey("pick") as! PFFile)
