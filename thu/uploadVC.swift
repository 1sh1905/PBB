...
//  thu
//
//  Created by TRI TRAN on 4/16/17.
...
class uploadVC: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate, CLLocationManagerDelegate {
    ...
    override func viewDidLoad() {
       ...
       removeBtn.hidden = true
        ...
        picImg.image = UIImage(named: "app-icon.jpg")
    //    titleTxt.text = ""
   ...
   override func viewWillAppear(animated: Bool) {
    ...
    func zoomImg() {
        ...
        let unzoomed = CGRectMake(15, 75, 70, 70)
    ...
    func alignment() {
        ...
        picImg.frame = CGRectMake(15, 75, 70, 70)
      ...
      removeBtn.frame = CGRectMake(picImg.frame.origin.x, picImg.frame.origin.y + 20, 70, 30)
    }
    ...
    @IBAction func publishBtn_clicked(sender: AnyObject) {
        ...
        //object["longitude"] = currentLocation.coordinate.longitude
        //object["latitude"] = currentLocation.coordinate.latitude
    ...
    @IBAction func remove_clicked(sender: AnyObject) {
   self.viewDidLoad()
    }
