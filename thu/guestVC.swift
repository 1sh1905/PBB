...
//  thu
//
//  Created by TRI TRAN on 4/14/17.
        ...
        query.findObjectsInBackgroundWithBlock ({ (objects:[PFObject]?, error:NSError?) -> Void in
            if error == nil {
                ...
                for object in objects! {
                    ...
                    self.picArray.append(object.valueForKey("pick") as! PFFile)
                }
    ...
    override func collectionView(collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, atIndexPath indexPath: NSIndexPath) -> UICollectionReusableView {
        ...
        infoQuery.findObjectsInBackgroundWithBlock ({ (objects:[PFObject]?, error:NSError?) -> Void in
            if error == nil {
                ...
                if objects!.isEmpty {
                    // call alert
                    let alert = UIAlertController(title: "\(guestname.last!.uppercaseString)", message: "We do not see this user or even a guest", preferredStyle: UIAlertControllerStyle.Alert)
